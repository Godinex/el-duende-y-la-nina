...
- **`foto`**: apunta a `assets/placeholder.svg`. Reemplazalo por una foto real tuya (ver sección 3).
...
```json
{
  ...
  "jugadores": "2-4",
  "edad": "8+",
  "foto": "assets/nombre-del-juego.jpg"
}
```
...
Poné las fotos de tus juegos dentro de la carpeta `assets/` y referenciá el nombre del archivo en el campo `"foto"` de cada juego en `games.json`. Mientras no tengas foto, dejá `"assets/placeholder.svg"`.
